    ...
    () => [
      {
        ...
        items: [
          ...
          { keys: t("keyboardShortcuts.keys.arrows"), action: t("keyboardShortcuts.actions.navigatePaletteResults") },
          { keys: "Enter", action: t("keyboardShortcuts.actions.runPaletteResult") },
          { keys: "Esc", action: t("keyboardShortcuts.actions.closeCommandPalette") },
      ...
      },
      {
        ...
        items: [
          ...
          { keys: "Shift + 1", action: t("keyboardShortcuts.actions.fitAll") },
          { keys: "Shift + 2", action: t("keyboardShortcuts.actions.fitSelection") },
          ...
          { keys: "Shift + L", action: t("keyboardShortcuts.actions.autoLayoutConceptual") },
